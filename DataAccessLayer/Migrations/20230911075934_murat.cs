        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutThumnailImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WritterId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WritterName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WritterAbout = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WritterImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WritterEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WritterPassword = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WritterStatus = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Writers", x => x.WritterId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blogs_Writers_WritterId",
